    ...
    <div className="theme-card rounded-lg p-8">
      ...
      <div className="grid grid-cols-1 gap-3 mb-8">
        {challenge.options?.map((option, index) => {
          let buttonClass =
            "w-full p-4 text-center rounded-lg border-2 border-b-4 transition-all duration-200 touch-manipulation select-none ";
      ...
      {!showResult && (
        <div className="mb-6">
          <button
            ...
            aria-label={
              selectedAnswer ? "Check your answer" : "Select an answer first"
            }
          >
            Check Answer
          </button>
      ...
      {showResult && (
        <div
          className={`p-4 rounded-lg ${isCorrect ? "theme-feedback-correct" : "theme-feedback-incorrect"}`}
        >
          <div className="flex items-center mb-2">
            <div
              className={`w-6 h-6 rounded-full flex items-center justify-center mr-3 ${isCorrect ? "bg-[var(--color-primary)]" : "bg-[var(--color-danger)]"}`}
            >
              {isCorrect ? (
                <svg
            ...
            <span
              className={`font-bold ${isCorrect ? "text-[var(--color-primary)]" : "text-[var(--color-danger)]"}`}
            >
