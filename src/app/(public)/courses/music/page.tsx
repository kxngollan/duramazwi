...
export const metadata: Metadata = {
  title: "Nziyo — Music & Dance in Shona Culture | Duramazwi",
  description:
    "Explore Shona music from the sacred mbira to chimurenga — traditional instruments, songs for every life event, dance styles, and the deep cultural significance of music in Shona life.",
};
...
const modules: {
...
}[] = [
  {
    ...
    shona: "Zviridzwa zveChivanhu",
    description:
      "From the sacred mbira to the hosho rattles — meet the instruments of Shona music, understand what they are made of, how they are played, and what role each carries in ceremony.",
    icon: <IconMusicNote />,
    tag: "Start here",
  },
  {
    ...
    title: "Shona Songs",
    shona: "Nziyo dzeShona",
    description:
      "Work songs, lullabies, wedding songs, and bira ceremony songs — every major moment in Shona life has its own musical tradition. Learn the vocabulary and the contexts.",
    icon: <IconStar />,
    tag: "Module 2",
  },
  {
    ...
    title: "Dance Styles",
    shona: "Mitambo yekutamba",
    description:
      "Jerusarema, Mbakumba, Muchongoyo, Dandaro — Shona dance is not decoration, it IS the ceremony. Discover the distinct regional dance traditions and their meanings.",
    icon: <IconUsers />,
    tag: "Module 3",
  },
  {
    href: "/courses/music/cultural-significance",
    title: "Cultural Significance of Music",
    shona: "Basa reNziyo muChinhu",
    description:
      "Why music is the primary vehicle of cultural transmission in Shona society — from chimurenga to mbira, from Thomas Mapfumo to the bira ceremony.",
    icon: <IconGlobe />,
    tag: "Module 4",
  },
];
    ...
    <div className="min-h-screen pb-20">
      ...
      <div className="py-16 px-6 text-center bg-[var(--color-primary)]">
        ...
        <p className="text-xl md:text-2xl font-light mb-2 text-[var(--color-hero-text)] opacity-85">
          Music &amp; Dance in Shona Culture
        </p>
        <p className="max-w-2xl mx-auto mt-6 text-base md:text-lg leading-relaxed text-[var(--color-hero-text)] opacity-75">
          The mbira does not just make music — it calls the ancestors. Shona
          culture is inseparable from its music: at births, deaths, weddings,
          harvests, and liberation struggles, there has always been a song. This
          course takes you inside the instruments, the songs, the dances, and the
          deep cultural meanings they carry.
        </p>
      </div>
          ...
          >
            <div>
              ...
              <p className="text-sm text-[var(--color-muted)]">
                20 challenges — 8 beginner, 8 intermediate, 4 advanced — covering
                instrument names, cultural context, and ceremony vocabulary.
              </p>
            </div>
