...
import { idiomsChallenges } from "@/components/challenge/idioms-challenges";
...
> = {
  easy: {
    label: "Beginner",
    description: "12 beginner challenges. Basic idiom recognition and literal vs figurative meaning.",
    difficulty: "beginner",
    count: 12,
    icon: <IconStar />,
  },
  medium: {
    label: "Intermediate",
    description: "12 intermediate challenges. Choose the right expression for a context and match animal symbolism.",
  ...
  hard: {
    label: "Advanced",
    description: "6 advanced challenges. Build idiomatic expressions and apply them in context.",
    difficulty: "advanced",
    count: 6,
    icon: <IconBolt />,
  },
...
function prepareChallenge(raw: (typeof idiomsChallenges)[0]): Challenge {
  return {
    id: raw.id,
...
function buildSet(mode: Mode): Challenge[] {
  ...
  const pool = cfg.difficulty
    ? idiomsChallenges.filter((c) => c.difficulty === cfg.difficulty)
    : shuffleArray([...idiomsChallenges]);
...
export default function IdiomsChallengesPage() {
