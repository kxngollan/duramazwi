...
import { religionChallenges } from "@/components/challenge/religion-challenges";
...
> = {
  easy: {
    label: "Easy",
    description: "8 beginner challenges. Religious vocabulary and basic belief concepts.",
    difficulty: "beginner",
    count: 8,
    icon: <IconStar />,
  },
  medium: {
    label: "Medium",
    description: "8 intermediate challenges. Traditional beliefs and Christian practice in context.",
  ...
  hard: {
    label: "Hard",
    description: "4 advanced challenges. Build religious and spiritual sentences in Shona.",
    difficulty: "advanced",
    count: 4,
    icon: <IconBolt />,
  },
...
function prepareChallenge(raw: (typeof religionChallenges)[0]): Challenge {
  return {
    id: raw.id,
...
function buildSet(mode: Mode): Challenge[] {
  ...
  const pool = cfg.difficulty
    ? religionChallenges.filter((c) => c.difficulty === cfg.difficulty)
    : shuffleArray([...religionChallenges]);
      ...
      <div className="bg-[var(--color-primary)] py-12 px-6">
        <div className="max-w-xl mx-auto">
          ...
          <h1 className="text-4xl font-bold text-[var(--color-hero-text)] mb-2">
            Religion &amp; Spirituality Challenges
          </h1>
...
export default function ReligionChallengesPage() {
