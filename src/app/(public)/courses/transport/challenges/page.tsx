...
import { transportChallenges } from "@/components/challenge/transport-challenges";
...
> = {
  easy: {
    label: "Easy",
    description: "12 beginner challenges. Direction words and transport vocabulary.",
    difficulty: "beginner",
    count: 12,
    icon: <IconStar />,
  },
  medium: {
    label: "Medium",
    description: "12 intermediate challenges. Giving directions and transport interactions.",
  ...
  hard: {
    label: "Hard",
    description: "6 advanced challenges. Build full direction-giving and travel assistance sentences.",
    difficulty: "advanced",
    count: 6,
    icon: <IconBolt />,
  },
...
function prepareChallenge(raw: (typeof transportChallenges)[0]): Challenge {
  return {
    id: raw.id,
...
function buildSet(mode: Mode): Challenge[] {
  ...
  const pool = cfg.difficulty
    ? transportChallenges.filter((c) => c.difficulty === cfg.difficulty)
    : shuffleArray([...transportChallenges]);
