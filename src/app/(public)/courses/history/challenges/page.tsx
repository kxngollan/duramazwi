...
import { historyChallenges } from "@/components/challenge/history-challenges";
...
> = {
  easy: {
    label: "Easy",
    description: "8 beginner challenges. Historical vocabulary and key names.",
    difficulty: "beginner",
    count: 8,
    icon: <IconStar />,
  },
  medium: {
    label: "Medium",
    description: "8 intermediate challenges. Events, periods, and cultural significance.",
  ...
  hard: {
    label: "Hard",
    description: "4 advanced challenges. Translation builder for heritage vocabulary.",
    difficulty: "advanced",
    count: 4,
    icon: <IconBolt />,
  },
...
function prepareChallenge(raw: (typeof historyChallenges)[0]): Challenge {
  return {
    id: raw.id,
...
function buildSet(mode: Mode): Challenge[] {
  ...
  const pool = cfg.difficulty
    ? historyChallenges.filter((c) => c.difficulty === cfg.difficulty)
    : shuffleArray([...historyChallenges]);
...
export default function HistoryChallengesPage() {
