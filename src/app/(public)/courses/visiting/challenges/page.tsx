...
import { visitingChallenges } from "@/components/challenge/visiting-challenges";
...
> = {
  easy: {
    label: "Easy",
    description: "8 beginner challenges. Arrival vocabulary and basic visiting phrases.",
    difficulty: "beginner",
    count: 8,
    icon: <IconStar />,
  },
  medium: {
    label: "Medium",
    description: "8 intermediate challenges. Hospitality interactions and navigation in context.",
  ...
  hard: {
    label: "Hard",
    description: "4 advanced challenges. Build visiting and hosting sentences in Shona.",
    difficulty: "advanced",
    count: 4,
    icon: <IconBolt />,
  },
...
function prepareChallenge(raw: (typeof visitingChallenges)[0]): Challenge {
  return {
    id: raw.id,
...
function buildSet(mode: Mode): Challenge[] {
  ...
  const pool = cfg.difficulty
    ? visitingChallenges.filter((c) => c.difficulty === cfg.difficulty)
    : shuffleArray([...visitingChallenges]);
...
export default function VisitingChallengesPage() {
