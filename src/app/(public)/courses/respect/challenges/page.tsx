...
import { respectChallenges } from "@/components/challenge/respect-challenges";
...
> = {
  easy: {
    label: "Easy",
    description: "12 beginner challenges. Respect vocabulary and basic etiquette.",
    difficulty: "beginner",
    count: 12,
    icon: <IconStar />,
  },
  medium: {
    label: "Medium",
    description: "12 intermediate challenges. Body language, gifts, and cultural scenarios.",
  ...
  hard: {
    label: "Hard",
    description: "6 advanced challenges. Build respectful Shona sentences and phrases.",
    difficulty: "advanced",
    count: 6,
    icon: <IconBolt />,
  },
...
function prepareChallenge(raw: (typeof respectChallenges)[0]): Challenge {
  return {
    id: raw.id,
...
function buildSet(mode: Mode): Challenge[] {
  ...
  const pool = cfg.difficulty
    ? respectChallenges.filter((c) => c.difficulty === cfg.difficulty)
    : shuffleArray([...respectChallenges]);
...
export default function RespectChallengesPage() {
