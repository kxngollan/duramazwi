...
export const metadata: Metadata = {
  title: "Kuremekedza — Respect & Etiquette in Shona | Duramazwi",
  description:
    "Learn how respect works in Shona culture — honouring elders, reading body language, visiting homes correctly, giving gifts, and choosing the right greeting for the right person.",
};
...
const IconGift = () => (
  <svg
    ...
    className="w-8 h-8"
  >
    <path d="M9.375 3a1.875 1.875 0 0 0 0 3.75h1.875v4.5H3.375A1.875 1.875 0 0 1 1.5 9.375v-.75c0-1.036.84-1.875 1.875-1.875h3.193A3.375 3.375 0 0 1 12 2.753a3.375 3.375 0 0 1 5.432 3.997h3.943c1.035 0 1.875.84 1.875 1.875v.75c0 1.036-.84 1.875-1.875 1.875H12.75v-4.5h1.875a1.875 1.875 0 1 0-1.875-1.875V6.75h-1.5V4.875C11.25 3.839 10.41 3 9.375 3ZM11.25 12.75H3v6.75a2.25 2.25 0 0 0 2.25 2.25h6v-9ZM12.75 21.75a2.25 2.25 0 0 0 2.25-2.25v-6.75h-4.5v9h2.25Z" />
  </svg>
);
...
const modules: {
...
}[] = [
  {
    ...
    shona: "Kuremekedza Vakuru",
    description:
      "How to address elders, why 'imi' matters, and the obligations children hold — the child greets first, always.",
    icon: <IconElders />,
    tag: "Start here",
  },
  {
    ...
    title: "Body Language",
    shona: "Muviri Unoreva",
    description:
      "Clapping, bowing, receiving with both hands, eye contact — the unspoken language of Shona respect.",
    icon: <IconHands />,
    tag: "Module 2",
  },
  {
    ...
    shona: "Kushanyira Kumba",
    description:
      "Announcing yourself at the gate, accepting the first drink, removing shoes — how to visit correctly.",
    icon: <IconHome />,
    tag: "Module 3",
  },
  {
    ...
    shona: "Kupa Zipo",
    description:
      "How to give and receive gifts respectfully, what to bring to a rural home, and why you never open a gift immediately.",
    icon: <IconGift />,
    tag: "Module 4",
  },
  {
    href: "/courses/respect/greetings-context",
    title: "Context-Appropriate Greetings",
    shona: "Kukwazisana Zvakanaka",
    description:
      "Why you cannot use the same greeting for a peer and a father-in-law — and how to read every relationship.",
    icon: <IconChat />,
    tag: "Module 5",
  },
];

export default function RespectCoursePage() {
  return (
    <div className="min-h-screen pb-20">
      ...
      <div className="py-16 px-6 text-center bg-[var(--color-primary)]">
        ...
        <p className="text-xl md:text-2xl font-light mb-2 text-[var(--color-hero-text)] opacity-85">
          Respect &amp; Etiquette in Shona
        </p>
        <p className="max-w-2xl mx-auto mt-6 text-base md:text-lg leading-relaxed text-[var(--color-hero-text)] opacity-75">
          In Shona culture, respect is not a feeling — it is a practice. How you
          stand, how you receive a gift, when you speak, and which word you choose
          for "you" all signal whether you understand the culture. This course
          teaches the vocabulary and the reasoning behind it.
        </p>
      </div>
          ...
          >
            <div>
              ...
              <p className="text-sm text-[var(--color-muted)]">
                ...
                covering all five modules. Vocabulary, cultural scenarios, and
                sentence building.
              </p>
            </div>
