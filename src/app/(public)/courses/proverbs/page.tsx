...
export const metadata: Metadata = {
  title: "Tsumo — Shona Proverbs | Duramazwi",
  description:
    "Learn Shona proverbs — their meanings, how to use them in conversation, and the cultural values they encode. Tsumo are the compressed wisdom of Shona culture.",
};
...
const modules: {
...
}[] = [
  {
    ...
    title: "Meanings of Tsumo",
    shona: "Zvinoreva Tsumo",
    description:
      "What a tsumo is, how to read one, and 15 essential Shona proverbs with their literal translations, meanings, and cultural context.",
    icon: <IconBook />,
    tag: "Start here",
  },
  {
    href: "/courses/proverbs/usage",
    title: "Using Tsumo in Conversation",
    shona: "Kushandisa Tsumo",
    description:
      "When and how proverbs are deployed — in dispute resolution, advice-giving, consolation, and celebration. Plus additional proverbs focused on real usage.",
    icon: <IconChat />,
    tag: "Module 2",
  },
  {
    href: "/courses/proverbs/cultural-lessons",
    title: "Cultural Lessons in Tsumo",
    shona: "Zvidzidzo zveChiShona",
    description:
      "Proverbs organised by the cultural values they encode — unity, humility, speech, hardship, wealth, and time. The moral world of the Shona people.",
    icon: <IconGlobe />,
    tag: "Module 3",
  },
];

export default function ProverbsCoursePage() {
  return (
    <div className="min-h-screen pb-20">
      ...
      <div className="py-16 px-6 text-center bg-[var(--color-primary)]">
        ...
        <p className="max-w-2xl mx-auto mt-6 text-base md:text-lg leading-relaxed text-[var(--color-hero-text)] opacity-75">
          Tsumo are the compressed wisdom of Shona culture. Elders drop them
          into conversation to teach, to correct, and to end arguments without
          direct confrontation. Knowing them marks you as someone who understands
          Shona at its deepest level.
        </p>
      </div>
          ...
          >
            <div>
              ...
              <p className="text-sm text-[var(--color-muted)]">
                ...
                covering all three modules. Match proverbs to meanings, identify
                cultural lessons, and build proverb sentences.
              </p>
            </div>
