...
import { proverbsChallenges } from "@/components/challenge/proverbs-challenges";
...
> = {
  easy: {
    label: "Beginner",
    description: "12 beginner challenges. Match proverbs to meanings and basic recognition.",
    difficulty: "beginner",
    count: 12,
    icon: <IconStar />,
  },
  medium: {
    label: "Intermediate",
    description: "12 intermediate challenges. Identify cultural lessons and choose the right proverb for a scenario.",
  ...
  hard: {
    label: "Advanced",
    description: "6 advanced challenges. Build proverb sentences and apply them in context.",
    difficulty: "advanced",
    count: 6,
    icon: <IconBolt />,
  },
...
function prepareChallenge(raw: (typeof proverbsChallenges)[0]): Challenge {
  return {
    id: raw.id,
...
function buildSet(mode: Mode): Challenge[] {
  ...
  const pool = cfg.difficulty
    ? proverbsChallenges.filter((c) => c.difficulty === cfg.difficulty)
    : shuffleArray([...proverbsChallenges]);
...
export default function ProverbsChallengesPage() {
