...
import { timeChallenges } from "@/components/challenge/time-challenges";
...
> = {
  easy: {
    label: "Easy",
    description: "16 beginner challenges. Day names, month names, and season identification.",
    difficulty: "beginner",
    count: 16,
    icon: <IconStar />,
  },
  medium: {
    label: "Medium",
    description: "16 intermediate challenges. Telling time, past/future vocabulary in context.",
  ...
  hard: {
    label: "Hard",
    description: "8 advanced challenges. Time-based sentences and full date expressions.",
    difficulty: "advanced",
    count: 8,
    icon: <IconBolt />,
  },
...
function prepareChallenge(raw: (typeof timeChallenges)[0]): Challenge {
  return {
    id: raw.id,
...
function buildSet(mode: Mode): Challenge[] {
  ...
  const pool = cfg.difficulty
    ? timeChallenges.filter((c) => c.difficulty === cfg.difficulty)
    : shuffleArray([...timeChallenges]);
...
export default function TimeChallengesPage() {
