...
export const metadata: Metadata = {
  title: "Nguva — Time & Dates in Shona | Duramazwi",
  description:
    "Learn how Shona speakers talk about time — days of the week, months, seasons, telling the hour, past and future, and special occasions.",
};
...
const modules: {
...
}[] = [
  {
    ...
    shona: "Mazuva esvondo",
    description:
      "Sunday through Saturday — including why Svondo comes from Portuguese, and why Saturday is the day of gathering and beer.",
    icon: <IconCalendar />,
    tag: "Start here",
  },
  {
    ...
    shona: "Mwedzi wegore",
    description:
      "The twelve months in Shona — each name reflects the agricultural cycle, rainfall, and natural events of the Zimbabwean year.",
    icon: <IconBookOpen />,
    tag: "Module 2",
  },
  {
    ...
    shona: "Mwaka",
    description:
      "Zhizha (rainy season), Chirimo (spring), and Chando (winter) — how seasons shape Shona life and language.",
    icon: <IconSun />,
    tag: "Module 3",
  },
  {
    ...
    shona: "Nguva",
    description:
      "How to say what time it is in Shona — from \"nguva yekutanga\" (1 o'clock) through half past and minutes, plus the concept of African time.",
    icon: <IconClock />,
    tag: "Module 4",
  },
  {
    ...
    title: "Past & Future",
    shona: "Kare neRamangwana",
    description:
      "Yesterday, today, tomorrow, last week, next year — and why Shona expresses the future differently from English.",
    icon: <IconArrows />,
    tag: "Module 5",
  },
  {
    ...
    shona: "Mazuva Akakosha",
    description:
      "Birthdays, Christmas, weddings, and New Year — the vocabulary of celebration and how Shona culture marks significant moments.",
    icon: <IconSparkles />,
    tag: "Module 6",
  },
];
    ...
    <div className="min-h-screen pb-20">
      ...
      <div className="py-16 px-6 text-center bg-[var(--color-primary)]">
        ...
        <p className="max-w-2xl mx-auto mt-6 text-base md:text-lg leading-relaxed text-[var(--color-hero-text)] opacity-75">
          In Shona, time is not just measured — it is felt through seasons,
          harvests, and the position of the sun. Month names reflect
          agriculture, not emperors. Saturday means gathering, not just the
          sixth day. This course teaches you not just the words, but the world
          they describe.
        </p>
      </div>
          ...
          >
            <div>
              ...
              <p className="text-sm text-[var(--color-muted)]">
                ...
                covering days, months, seasons, telling time, and time
                expressions.
              </p>
            </div>
