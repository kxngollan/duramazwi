...
import { numbersChallenges } from "@/components/challenge/numbers-challenges";
...
> = {
  easy: {
    label: "Easy",
    description: "16 beginner challenges. Number recognition and basic counting vocabulary.",
    difficulty: "beginner",
    count: 16,
    icon: <IconStar />,
  },
  medium: {
    label: "Medium",
    description: "16 intermediate challenges. Noun agreement and money vocabulary in context.",
  ...
  hard: {
    label: "Hard",
    description: "8 advanced challenges. Full market sentences and price negotiations.",
    difficulty: "advanced",
    count: 8,
    icon: <IconBolt />,
  },
...
function prepareChallenge(raw: (typeof numbersChallenges)[0]): Challenge {
  return {
    id: raw.id,
...
function buildSet(mode: Mode): Challenge[] {
  ...
  const pool = cfg.difficulty
    ? numbersChallenges.filter((c) => c.difficulty === cfg.difficulty)
    : shuffleArray([...numbersChallenges]);
...
export default function NumbersChallengesPage() {
