...
import { emotionsChallenges } from "@/components/challenge/emotions-challenges";
...
> = {
  easy: {
    label: "Easy",
    description: "12 beginner challenges. Emotion vocabulary and basic recognition.",
    difficulty: "beginner",
    count: 12,
    icon: <IconStar />,
  },
  medium: {
    label: "Medium",
    description: "12 intermediate challenges. Contextual usage and cultural understanding.",
  ...
  hard: {
    label: "Hard",
    description: "6 advanced challenges. Build emotional expression sentences in Shona.",
    difficulty: "advanced",
    count: 6,
    icon: <IconBolt />,
  },
...
function prepareChallenge(raw: (typeof emotionsChallenges)[0]): Challenge {
  return {
    id: raw.id,
...
function buildSet(mode: Mode): Challenge[] {
  ...
  const pool = cfg.difficulty
    ? emotionsChallenges.filter((c) => c.difficulty === cfg.difficulty)
    : shuffleArray([...emotionsChallenges]);
...
export default function EmotionsChallengesPage() {
