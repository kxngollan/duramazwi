...
import { pronunciationChallenges } from "@/components/challenge/pronunciation-challenges";
...
> = {
  easy: {
    label: "Easy",
    description: "12 beginner challenges. Letter recognition, vowels, and basic vocabulary.",
    difficulty: "beginner",
    count: 12,
    icon: <IconStar />,
  },
  medium: {
    label: "Medium",
    description: "12 intermediate challenges. Noun classes, plurals, and consonant clusters.",
  ...
  hard: {
    label: "Hard",
    description: "6 advanced challenges. Tone, full pattern recognition, and word building.",
    difficulty: "advanced",
    count: 6,
    icon: <IconBolt />,
  },
...
function prepareChallenge(raw: (typeof pronunciationChallenges)[0]): Challenge {
  return {
    id: raw.id,
...
function buildSet(mode: Mode): Challenge[] {
  ...
  const pool = cfg.difficulty
    ? pronunciationChallenges.filter((c) => c.difficulty === cfg.difficulty)
    : shuffleArray([...pronunciationChallenges]);
...
export default function PronunciationChallengesPage() {
