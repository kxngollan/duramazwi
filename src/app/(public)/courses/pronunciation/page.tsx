...
export const metadata: Metadata = {
  title: "Pronunciation & Reading in Shona | Duramazwi",
  description:
    "Master Shona pronunciation — the alphabet, vowel sounds, consonant clusters, noun class spelling patterns, and tone.",
};
...
const IconPuzzle = () => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M11.622 1.602a.75.75 0 0 1 .756 0l2.25 1.313a.75.75 0 0 1-.756 1.295L12 3.118 10.128 4.21a.75.75 0 1 1-.756-1.295l2.25-1.313ZM5.898 5.81a.75.75 0 0 1-.27 1.025l-1.14.665 1.14.665a.75.75 0 1 1-.756 1.295L3.75 8.806v.944a.75.75 0 0 1-1.5 0V7.5a.75.75 0 0 1 .372-.648l2.25-1.312a.75.75 0 0 1 1.026.27Zm12.204 0a.75.75 0 0 1 1.026-.27l2.25 1.312a.75.75 0 0 1 .372.648v2.25a.75.75 0 0 1-1.5 0v-.944l-1.122.655a.75.75 0 1 1-.756-1.295l1.14-.665-1.14-.665a.75.75 0 0 1-.27-1.026Zm-9 5.25a.75.75 0 0 1 1.026-.27L12 11.882l1.872-1.092a.75.75 0 1 1 .756 1.295l-1.878 1.096V14.5a.75.75 0 0 1-1.5 0v-1.32l-1.878-1.095a.75.75 0 0 1-.27-1.026ZM3 13.5a.75.75 0 0 1 .75.75v1.32l1.878 1.095a.75.75 0 1 1-.756 1.295l-2.25-1.312A.75.75 0 0 1 2.25 16v-2.25A.75.75 0 0 1 3 13.5Zm18 0a.75.75 0 0 1 .75.75V16a.75.75 0 0 1-.372.648l-2.25 1.313a.75.75 0 0 1-.756-1.295l1.878-1.096V14.25a.75.75 0 0 1 .75-.75Zm-9 5.25a.75.75 0 0 1 .75.75v.944l1.122-.655a.75.75 0 1 1 .756 1.295l-2.25 1.312a.75.75 0 0 1-.756 0l-2.25-1.312a.75.75 0 1 1 .756-1.295l1.122.655V19.5a.75.75 0 0 1 .75-.75Z"
      clipRule="evenodd"
    />
  </svg>
);

const IconMusicalNote = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
...
const modules: {
...
}[] = [
  {
    ...
    title: "The Shona Alphabet",
    shona: "Mavara eChiShona",
    description:
      "25 letters, no silent ones. Learn the special consonant clusters — ch, dz, mb, mh, ng, sh, sv, tsh — that make Shona sound like Shona.",
    icon: <IconLetters />,
    tag: "Start here",
  },
  {
    ...
    shona: "Mitemo yeKutaura",
    description:
      "Eight core rules: every letter pronounced, rolled r, bilabial bv, the dz cluster, open syllables, and more.",
    icon: <IconSpeaker />,
    tag: "Module 2",
  },
  {
    ...
    shona: "Maitiro ekuNyora",
    description:
      "Noun class prefixes (mu-, va-, chi-, zvi-), the infinitive ku-, and how plurals are formed — the grammar hiding inside spelling.",
    icon: <IconPuzzle />,
    tag: "Module 3",
  },
  {
    ...
    shona: "Mhepo yeMazwi",
    description:
      "Shona is a tonal language. Same letters, different pitch — different meaning. Learn what that means and how to start hearing it.",
    icon: <IconMusicalNote />,
    tag: "Module 4",
  },
];

export default function PronunciationCoursePage() {
  return (
    <div className="min-h-screen pb-20">
      ...
      <div className="py-16 px-6 text-center bg-[var(--color-primary)]">
        ...
        <p className="max-w-2xl mx-auto mt-6 text-base md:text-lg leading-relaxed text-[var(--color-hero-text)] opacity-75">
          Shona is almost entirely phonetic — every letter is pronounced, every
          vowel is clear and consistent. Once you understand the consonant
          clusters and the noun class system, reading Shona aloud becomes
          natural. This course builds that foundation from the alphabet up.
        </p>
      </div>
          ...
          >
            <div>
              ...
              <p className="text-sm text-[var(--color-muted)]">
                ...
                covering letters, noun classes, consonant clusters, and tone.
                Test your reading and pattern recognition.
              </p>
            </div>
