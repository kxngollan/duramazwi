...
import { parentingChallenges } from "@/components/challenge/parenting-challenges";
...
> = {
  easy: {
    label: "Easy",
    description: "8 beginner challenges. Vocabulary about children and parenting roles.",
    difficulty: "beginner",
    count: 8,
    icon: <IconStar />,
  },
  medium: {
    label: "Medium",
    description: "8 intermediate challenges. Respect vocabulary and family role descriptions.",
  ...
  hard: {
    label: "Hard",
    description: "4 advanced challenges. Parenting and family role sentences.",
    difficulty: "advanced",
    count: 4,
    icon: <IconBolt />,
  },
...
function prepareChallenge(raw: (typeof parentingChallenges)[0]): Challenge {
  return {
    id: raw.id,
...
function buildSet(mode: Mode): Challenge[] {
  ...
  const pool = cfg.difficulty
    ? parentingChallenges.filter((c) => c.difficulty === cfg.difficulty)
    : shuffleArray([...parentingChallenges]);
...
export default function ParentingChallengesPage() {
