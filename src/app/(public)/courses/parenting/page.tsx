...
export const metadata: Metadata = {
  title: "Kurera — Children & Parenting in Shona | Duramazwi",
  description:
    "Learn how children are raised in Shona culture — the vocabulary of childhood, respect for elders, and the family roles that shape every Shona child's life.",
};
...
const modules: {
...
}[] = [
  {
    ...
    shona: "Kurera Vana",
    description:
      "Mwana, mbereko, and kukura — the vocabulary of raising a Shona child and the village that participates in it.",
    icon: <IconChild />,
    tag: "Start here",
  },
  {
    ...
    description:
      "Clapping greetings, speaking respectfully, and the ancestral authority of vadzimu — how Shona children learn to honour those who came before.",
    icon: <IconElders />,
    tag: "Module 2",
  },
  {
    ...
    shona: "Mabasa eMhuri",
    description:
      "Muzukuru, muroora, mukomana, musikana — the roles children grow into and the complementary expectations placed on boys and girls.",
    icon: <IconRoles />,
    tag: "Module 3",
  },
];
    ...
    <div className="min-h-screen pb-20">
      ...
      <div className="py-16 px-6 text-center bg-[var(--color-primary)]">
        ...
        <p className="text-xl md:text-2xl font-light mb-2 text-[var(--color-hero-text)] opacity-85">
          Children &amp; Parenting in Shona
        </p>
        <p className="max-w-2xl mx-auto mt-6 text-base md:text-lg leading-relaxed text-[var(--color-hero-text)] opacity-75">
          In Shona culture, raising a child is not the job of two parents — it
          is the work of the whole village. Grandmothers teach, aunts discipline,
          neighbours watch, and ancestors guide. This course gives you the
          language to understand how Shona children are raised, how they learn
          respect, and what roles await them as they grow.
        </p>
      </div>
          ...
          >
            <div>
              ...
              <p className="text-sm text-[var(--color-muted)]">
                ...
                all three modules. Study the full list or use it to review before
                the daily challenge.
              </p>
            </div>
