...
const IconShield = () => <GiTotemHead className="w-8 h-8" />;
...
const modules: {
  ...
  },
  {
    ...
    title: "Roora",
    shona: "Bride Wealth & the Marriage Covenant",
    description:
      "The step-by-step process of roora — why it is done, who the munyai is, what mombe youmai means, and how it has adapted to the modern world.",
    icon: <IconGift />,
    tag: "Module 4",
  },
  {
