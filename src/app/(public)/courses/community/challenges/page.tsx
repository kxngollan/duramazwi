...
import { communityChallenges } from "@/components/challenge/community-challenges";
...
> = {
  easy: {
    label: "Easy",
    description: "12 beginner challenges. Friendship and community vocabulary.",
    difficulty: "beginner",
    count: 12,
    icon: <IconStar />,
  },
  medium: {
    label: "Medium",
    description: "12 intermediate challenges. Social obligations and community terms in context.",
  ...
  hard: {
    label: "Hard",
    description: "6 advanced challenges. Community and social obligation sentences.",
    difficulty: "advanced",
    count: 6,
    icon: <IconBolt />,
  },
...
function prepareChallenge(raw: (typeof communityChallenges)[0]): Challenge {
  return {
    id: raw.id,
...
function buildSet(mode: Mode): Challenge[] {
  ...
  const pool = cfg.difficulty
    ? communityChallenges.filter((c) => c.difficulty === cfg.difficulty)
    : shuffleArray([...communityChallenges]);
