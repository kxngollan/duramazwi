...
import { greetingsChallenges } from "@/components/challenge/greetings-challenges";
...
> = {
  easy: {
    label: "Easy",
    description: "12 beginner challenges. Basic vocabulary and time-of-day greetings.",
    difficulty: "beginner",
    count: 12,
    icon: <IconStar />,
  },
  medium: {
    label: "Medium",
    description: "12 intermediate challenges. Formal vs informal, elder etiquette.",
  ...
  hard: {
    label: "Hard",
    description: "6 advanced challenges. Full greeting exchanges and farewells.",
    difficulty: "advanced",
    count: 6,
    icon: <IconBolt />,
  },
...
function prepareChallenge(raw: (typeof greetingsChallenges)[0]): Challenge {
  return {
    id: raw.id,
...
function buildSet(mode: Mode): Challenge[] {
  ...
  const pool = cfg.difficulty
    ? greetingsChallenges.filter((c) => c.difficulty === cfg.difficulty)
    : shuffleArray([...greetingsChallenges]);
...
export default function GreetingsChallengesPage() {
