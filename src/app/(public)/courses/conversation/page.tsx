...
export const metadata: Metadata = {
  title: "Conversation Practice — Shona in Real Life | Duramazwi",
  description:
    "Practice Shona conversation across five real-life settings — at home, at school, at work, in church, and in the village.",
};
...
const IconChurch = () => (
  <svg
    ...
    className="w-8 h-8"
  >
    <path d="M19.006 3.705a.75.75 0 1 0-.512-1.41L6 6.838V3a.75.75 0 0 0-.75-.75h-1.5A.75.75 0 0 0 3 3v4.539L1.006 8.26a.75.75 0 0 0 .512 1.41l1.482-.538V21a.75.75 0 0 0 .75.75H8.25a.75.75 0 0 0 .75-.75v-4.5a.75.75 0 0 1 .75-.75h4.5a.75.75 0 0 1 .75.75V21a.75.75 0 0 0 .75.75h4.5a.75.75 0 0 0 .75-.75V9.131l1.482.539a.75.75 0 0 0 .512-1.41l-1.994-.726V3.839l-1.994-.134Z" />
  </svg>
);
...
const IconTree = () => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M12 2.25a.75.75 0 0 1 .75.75v.756a49.106 49.106 0 0 1 9.152 1 .75.75 0 0 1-.152 1.485h-1.918l2.474 10.124a.75.75 0 0 1-.375.84A6.723 6.723 0 0 1 18.75 18a6.723 6.723 0 0 1-3.181-.795.75.75 0 0 1-.375-.84l2.474-10.124H12.75v13.28c1.293.076 2.534.343 3.697.776a.75.75 0 0 1-.262 1.453h-8.37a.75.75 0 0 1-.262-1.453c1.162-.433 2.404-.7 3.697-.775V6.24H9.008l2.474 10.124a.75.75 0 0 1-.375.84A6.723 6.723 0 0 1 7.926 18a6.723 6.723 0 0 1-3.181-.795.75.75 0 0 1-.375-.84L6.844 7.241H4.926a.75.75 0 0 1-.152-1.485 49.105 49.105 0 0 1 9.152-1V3a.75.75 0 0 1 .75-.75Z"
      clipRule="evenodd"
    />
  </svg>
);
...
const modules: {
...
}[] = [
  {
    ...
    shona: "Kumba",
    description:
      "Waking the family, asking about meals, discussing the day — the conversations that happen around every Shona household every day.",
    icon: <IconHome />,
    tag: "Start here",
  },
  {
    ...
    shona: "Kuchikoro",
    description:
      "Asking the teacher a question, explaining you don't understand, greeting classmates, and saying goodbye at the end of the school day.",
    icon: <IconAcademic />,
    tag: "Module 2",
  },
  {
    ...
    shona: "Kubasa",
    description:
      "Greeting colleagues, discussing tasks in meetings, and navigating the mix of Shona and English that characterises Zimbabwean workplaces.",
    icon: <IconBriefcase />,
    tag: "Module 3",
  },
  {
    ...
    shona: "Mukereke",
    description:
      "Worship, prayer, hymns, testimony, and the language of faith that fills Zimbabwe's long and expressive church services.",
    icon: <IconChurch />,
    tag: "Module 4",
  },
  {
    ...
    shona: "Kumusha",
    description:
      "Communal greetings, work parties (nhimbe), the evening fire (dare), and the more traditional Shona spoken beyond the city.",
    icon: <IconTree />,
    tag: "Module 5",
  },
];
    ...
    <div className="min-h-screen pb-20">
      ...
      <div className="py-16 px-6 text-center bg-[var(--color-primary)]">
        ...
        <p className="max-w-2xl mx-auto mt-6 text-base md:text-lg leading-relaxed text-[var(--color-hero-text)] opacity-75">
          Language lives in context. This course takes you through the five
          settings where most Shona conversation happens — home, school, work,
          church, and the village. Each module gives you the real phrases,
          dialogues, and cultural knowledge to participate, not just observe.
        </p>
      </div>
          ...
          >
            <div>
              ...
              <p className="text-sm text-[var(--color-muted)]">
                ...
                covering key phrase identification, context-appropriate
                responses, and full conversational exchanges across all five
                settings.
              </p>
            </div>
