...
import { homeChallenges } from "@/components/challenge/home-challenges";
...
> = {
  easy: {
    label: "Easy",
    description: "12 beginner challenges. Room names and furniture vocabulary.",
    difficulty: "beginner",
    count: 12,
    icon: <IconStar />,
  },
  medium: {
    label: "Medium",
    description: "12 intermediate challenges. Chores vocabulary and daily routine sequences.",
  ...
  hard: {
    label: "Hard",
    description: "6 advanced challenges. Full household instructions and cultural descriptions.",
    difficulty: "advanced",
    count: 6,
    icon: <IconBolt />,
  },
...
function prepareChallenge(raw: (typeof homeChallenges)[0]): Challenge {
  return {
    id: raw.id,
...
function buildSet(mode: Mode): Challenge[] {
  ...
  const pool = cfg.difficulty
    ? homeChallenges.filter((c) => c.difficulty === cfg.difficulty)
    : shuffleArray([...homeChallenges]);
