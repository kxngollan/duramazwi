...
export const metadata: Metadata = {
  title: "Imba — Home & Household in Shona | Duramazwi",
  description:
    "Learn the Shona language of the home — rooms, furniture, chores, and daily routines. Understand the cultural meanings behind the dare, the dura, and household rhythms.",
};
...
const modules: {
...
}[] = [
  {
    ...
    shona: "Nzvimbo Dzeimba",
    description:
      "Kitchen, bedroom, living room, bathroom, veranda, and the dare — plus the granary that was as important as the main house.",
    icon: <IconDoor />,
    tag: "Start here",
  },
  {
    ...
    shona: "Zvinhu Zveimba",
    description:
      "Tables, beds, plates, pots, grass mats, clay water pots, and traditional baskets — the objects that make a Shona home.",
    icon: <IconChair />,
    tag: "Module 2",
  },
  {
    ...
    shona: "Mabasa Eimba",
    description:
      "Sweeping, fetching water, washing dishes, cultivating, and the collective chore culture where no one works alone.",
    icon: <IconBroom />,
    tag: "Module 3",
  },
  {
    ...
    shona: "Mabasa Ezuva Nezuva",
    description:
      "Waking before sunrise, morning chores, going to school, returning home, and the evening meal that brings everyone together.",
    icon: <IconSun />,
    tag: "Module 4",
  },
];
    ...
    <div className="min-h-screen pb-20">
      ...
      <div className="bg-[var(--color-primary)] py-12 px-6 text-center">
        ...
        <p className="text-xl md:text-2xl font-light mb-2 text-[var(--color-hero-text)] opacity-85">
          Home &amp; Household in Shona
        </p>
        <p className="max-w-2xl mx-auto mt-6 text-base md:text-lg leading-relaxed text-[var(--color-hero-text)] opacity-75">
          The Shona home is more than four walls — it is a structure of
          relationships, responsibilities, and memory. The dare (courtyard) is
          where stories are told. The dura (granary) is where security lives.
          This course teaches you the language of the Shona household from
          rooms to routines.
        </p>
      </div>
          ...
          >
            <div>
              ...
              <p className="text-sm text-[var(--color-muted)]">
                ...
                covering all four modules. Study the full list or use it to
