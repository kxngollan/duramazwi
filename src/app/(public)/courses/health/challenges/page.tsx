...
import { healthChallenges } from "@/components/challenge/health-challenges";
...
> = {
  easy: {
    label: "Easy",
    description: "12 beginner challenges. Body parts and basic health vocabulary.",
    difficulty: "beginner",
    count: 12,
    icon: <IconStar />,
  },
  medium: {
    label: "Medium",
    description: "12 intermediate challenges. Illness descriptions and clinic interactions.",
  ...
  hard: {
    label: "Hard",
    description: "6 advanced challenges. Build health conversation sentences in Shona.",
    difficulty: "advanced",
    count: 6,
    icon: <IconBolt />,
  },
...
function prepareChallenge(raw: (typeof healthChallenges)[0]): Challenge {
  return {
    id: raw.id,
...
function buildSet(mode: Mode): Challenge[] {
  ...
  const pool = cfg.difficulty
    ? healthChallenges.filter((c) => c.difficulty === cfg.difficulty)
    : shuffleArray([...healthChallenges]);
