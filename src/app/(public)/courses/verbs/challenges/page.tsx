...
import { verbsChallenges } from "@/components/challenge/verbs-challenges";
...
> = {
  easy: {
    label: "Easy",
    description: "16 beginner challenges. Verb recognition and infinitive form matching.",
    difficulty: "beginner",
    count: 16,
    icon: <IconStar />,
  },
  medium: {
    label: "Medium",
    description: "16 intermediate challenges. Conjugation practice and tense selection.",
  ...
  hard: {
    label: "Hard",
    description: "8 advanced challenges. Build full Shona sentences with correct tense.",
    difficulty: "advanced",
    count: 8,
    icon: <IconBolt />,
  },
...
function prepareChallenge(raw: (typeof verbsChallenges)[0]): Challenge {
  return {
    id: raw.id,
...
function buildSet(mode: Mode): Challenge[] {
  ...
  const pool = cfg.difficulty
    ? verbsChallenges.filter((c) => c.difficulty === cfg.difficulty)
    : shuffleArray([...verbsChallenges]);
...
export default function VerbsChallengesPage() {
