...
export const metadata: Metadata = {
  title: "Common Verbs — Shona Verbs Course | Duramazwi",
  description:
    "Learn the most common Shona verbs — everyday actions, conjugation patterns, and tenses — to unlock full sentence-building in Shona.",
};
...
const modules: {
...
}[] = [
  {
    ...
    shona: "Zviito Zvezuva nezuva",
    description:
      "The 24 most essential Shona verbs — from eating and sleeping to working and laughing — all in their infinitive ku- form with examples.",
    icon: <IconBook />,
    tag: "Start here",
  },
  {
    ...
    shona: "Kupinda kwechiverb",
    description:
      "How subject prefixes work — Ndi-, U-, A-, Ti-, Mu-, Va- — plus how to form the present tense and add object infixes.",
    icon: <IconCog />,
    tag: "Module 2",
  },
  {
    ...
    title: "Tenses",
    shona: "Nguva dzekutaura",
    description:
      "Present habitual, present progressive, simple past, recent past, future, and remote past — each tense with multiple verb examples.",
    icon: <IconClock />,
    tag: "Module 3",
  },
];

export default function VerbsCoursePage() {
  return (
    <div className="min-h-screen pb-20">
      ...
      <div className="py-16 px-6 text-center bg-[var(--color-primary)]">
        ...
        <p className="text-xl md:text-2xl font-light mb-2 text-[var(--color-hero-text)] opacity-85">
          Common Verbs in Shona
        </p>
        <p className="max-w-2xl mx-auto mt-6 text-base md:text-lg leading-relaxed text-[var(--color-hero-text)] opacity-75">
          Verbs are the engine of every sentence. In Shona, mastering the ku-
          infinitive form and a handful of subject prefixes unlocks the ability
          to say almost anything. This course teaches you the 24 most common
          verbs, how to conjugate them for any person, and how to place them
          in the right tense.
        </p>
      </div>
          ...
          >
            <div>
              ...
              <p className="text-sm text-[var(--color-muted)]">
                ...
                covering verb recognition, conjugation, and full sentence
                building with correct tense.
              </p>
            </div>
