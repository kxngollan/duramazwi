...
import { foodChallenges } from "@/components/challenge/food-challenges";
...
> = {
  easy: {
    label: "Easy",
    description: "16 beginner challenges. Food names and cooking vocabulary.",
    difficulty: "beginner",
    count: 16,
    icon: <IconStar />,
  },
  medium: {
    label: "Medium",
    description: "14 intermediate challenges. Cooking sequences and ordering phrases.",
  ...
  hard: {
    label: "Hard",
    description: "10 advanced challenges. Hospitality expressions and full meal context.",
    difficulty: "advanced",
    count: 10,
    icon: <IconBolt />,
  },
...
function prepareChallenge(raw: (typeof foodChallenges)[0]): Challenge {
  return {
    id: raw.id,
...
function buildSet(mode: Mode): Challenge[] {
  ...
  const pool = cfg.difficulty
    ? foodChallenges.filter((c) => c.difficulty === cfg.difficulty)
    : shuffleArray([...foodChallenges]);
...
export default function FoodChallengesPage() {
