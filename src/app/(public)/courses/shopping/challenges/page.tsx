...
import { shoppingChallenges } from "@/components/challenge/shopping-challenges";
...
> = {
  easy: {
    label: "Easy",
    description: "12 beginner challenges. Market vocabulary and product names.",
    difficulty: "beginner",
    count: 12,
    icon: <IconStar />,
  },
  medium: {
    label: "Medium",
    description: "12 intermediate challenges. Negotiation phrases and price conversations.",
  ...
  hard: {
    label: "Hard",
    description: "6 advanced challenges. Build full market interaction sentences.",
    difficulty: "advanced",
    count: 6,
    icon: <IconBolt />,
  },
...
function prepareChallenge(raw: (typeof shoppingChallenges)[0]): Challenge {
  return {
    id: raw.id,
...
function buildSet(mode: Mode): Challenge[] {
  ...
  const pool = cfg.difficulty
    ? shoppingChallenges.filter((c) => c.difficulty === cfg.difficulty)
    : shuffleArray([...shoppingChallenges]);
...
export default function ShoppingChallengesPage() {
