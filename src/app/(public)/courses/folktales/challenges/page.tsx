...
import { folktalesChallenges } from "@/components/challenge/folktales-challenges";
...
> = {
  easy: {
    label: "Easy",
    description: "8 beginner challenges. Ngano vocabulary and character identification.",
    difficulty: "beginner",
    count: 8,
    icon: <IconStar />,
  },
  medium: {
    label: "Medium",
    description: "8 intermediate challenges. Moral themes and story element questions.",
  ...
  hard: {
    label: "Hard",
    description: "4 advanced challenges. Build storytelling vocabulary and phrases.",
    difficulty: "advanced",
    count: 4,
    icon: <IconBolt />,
  },
...
function prepareChallenge(raw: (typeof folktalesChallenges)[0]): Challenge {
  return {
    id: raw.id,
...
function buildSet(mode: Mode): Challenge[] {
  ...
  const pool = cfg.difficulty
    ? folktalesChallenges.filter((c) => c.difficulty === cfg.difficulty)
    : shuffleArray([...folktalesChallenges]);
...
export default function FolktalesChallengesPage() {
