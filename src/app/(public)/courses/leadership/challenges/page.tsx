...
import { leadershipChallenges } from "@/components/challenge/leadership-challenges";
...
> = {
  easy: {
    label: "Easy",
    description: "8 beginner challenges. Leadership vocabulary and chief/headman distinctions.",
    difficulty: "beginner",
    count: 8,
    icon: <IconStar />,
  },
  medium: {
    label: "Medium",
    description: "8 intermediate challenges. Governance concepts and conflict resolution vocabulary.",
  ...
  hard: {
    label: "Hard",
    description: "4 advanced challenges. Build governance and leadership sentences in Shona.",
    difficulty: "advanced",
    count: 4,
    icon: <IconBolt />,
  },
...
function prepareChallenge(raw: (typeof leadershipChallenges)[0]): Challenge {
  return {
    id: raw.id,
...
function buildSet(mode: Mode): Challenge[] {
  ...
  const pool = cfg.difficulty
    ? leadershipChallenges.filter((c) => c.difficulty === cfg.difficulty)
    : shuffleArray([...leadershipChallenges]);
