...
export const metadata: Metadata = {
  title: "Basa neCherechedzo — Work & School in Shona | Duramazwi",
  description:
    "Learn Shona for the workplace and classroom — office vocabulary, professional communication, classroom phrases, and the cultural roots of teamwork.",
};
...
const IconAcademicCap = () => (
  ...
  >
    ...
    <path d="M13.06 15.473a48.45 48.45 0 0 1 7.666-3.282c.134 1.414.22 2.843.255 4.284a.75.75 0 0 1-.46.711 47.87 47.87 0 0 1-8.105 2.571.75.75 0 0 1-.832-.607 48.24 48.24 0 0 1-.612-3.01.75.75 0 0 1 .085-.588ZM5.082 19.673a48.49 48.49 0 0 1 8.103-2.57.75.75 0 0 0 .46-.71 47.977 47.977 0 0 0-.254-4.285 48.45 48.45 0 0 0-7.666 3.282.75.75 0 0 0-.085.588l.614 3.01a.75.75 0 0 0 .828.685Z" />
  </svg>
);
...
const modules: {
...
}[] = [
  {
    ...
    shona: "Muhofisi",
    description:
      "Desks, meetings, deadlines, and colleagues — the vocabulary of a Zimbabwean workplace and how to navigate its social customs.",
    icon: <IconBriefcase />,
    tag: "Start here",
  },
  {
    ...
    shona: "Mukirasi",
    description:
      "Teachers, students, questions, and answers — classroom language and the deep cultural respect for education in Zimbabwe.",
  ...
  },
  {
    ...
    shona: "Kutaura Kwepabasa",
    description:
      "How to write formally, make requests, introduce yourself, and navigate professional Shona with the right register.",
    icon: <IconChatBubble />,
    tag: "Module 3",
  },
  {
    ...
    description:
      "From the traditional nhimbe work party to the modern office team — the Shona vocabulary and values of working together.",
    icon: <IconUsers />,
    tag: "Module 4",
  },
];

export default function WorkplaceCoursePage() {
  return (
    <div className="min-h-screen pb-20">
      ...
      <div className="py-16 px-6 text-center bg-[var(--color-primary)]">
        ...
        <p className="text-xl md:text-2xl font-light mb-2 text-[var(--color-hero-text)] opacity-85">
          Work &amp; School in Shona
        </p>
        <p className="max-w-2xl mx-auto mt-6 text-base md:text-lg leading-relaxed text-[var(--color-hero-text)] opacity-75">
          In Zimbabwe, work and school are not just activities — they are
          obligations of honour. Parents sacrifice enormously for school fees.
          Colleagues greet each other every morning without exception. This
          course gives you the language to participate in both worlds.
        </p>
      </div>
          ...
          >
            <div>
              ...
              <p className="text-sm text-[var(--color-muted)]">
                ...
                covering all four modules. Test yourself on office vocab,
                classroom phrases, and professional Shona sentences.
              </p>
            </div>
