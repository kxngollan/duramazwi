...
import { workplaceChallenges } from "@/components/challenge/workplace-challenges";
...
> = {
  easy: {
    label: "Easy",
    description: "12 beginner challenges. Workplace and classroom vocabulary.",
    difficulty: "beginner",
    count: 12,
    icon: <IconStar />,
  },
  medium: {
    label: "Medium",
    description: "12 intermediate challenges. Professional phrases and classroom interactions.",
  ...
  hard: {
    label: "Hard",
    description: "6 advanced challenges. Build professional and academic Shona sentences.",
    difficulty: "advanced",
    count: 6,
    icon: <IconBolt />,
  },
...
function prepareChallenge(raw: (typeof workplaceChallenges)[0]): Challenge {
  return {
    id: raw.id,
...
function buildSet(mode: Mode): Challenge[] {
  ...
  const pool = cfg.difficulty
    ? workplaceChallenges.filter((c) => c.difficulty === cfg.difficulty)
    : shuffleArray([...workplaceChallenges]);
...
export default function WorkplaceChallengesPage() {
